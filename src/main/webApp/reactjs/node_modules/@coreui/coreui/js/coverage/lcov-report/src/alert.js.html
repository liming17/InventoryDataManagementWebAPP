...
<head>
    <title>Code coverage report for src/alert.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> alert.js</h1>
        <div class='clearfix'>
...
&nbsp;
  _destroyElement(element) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (element.parentNode) {
...
&nbsp;
  static handleDismiss(alertInstance) {
    return function (event) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (event) {
