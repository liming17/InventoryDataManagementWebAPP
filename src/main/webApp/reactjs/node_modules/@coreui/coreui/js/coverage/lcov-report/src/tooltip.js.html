...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> tooltip.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">93.69% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>282/301</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>282/299</span>
            </div>
...
<a name='L847'></a><a href='#L847'>847</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
class Tooltip {
  constructor(element, config) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof createPopper === 'undefined') {
<span class="cstat-no" title="statement not covered" >      throw new TypeError('CoreUI\'s tooltips require Popper.js (https://popper.js.org)')</span>
    }
&nbsp;
    // private
...
<span class="branch-1 cbranch-no" title="branch not covered" >        shadowRoot.contains(this.element)</span>
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.element.ownerDocument.documentElement.contains(this.tip)) {
...
&nbsp;
  hide() {
    const tip = this.getTipElement()
    const complete = () =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this._hoverState !== HOVER_STATE_SHOW &amp;&amp; tip.parentNode) {
...
&nbsp;
  _getPopperConfig(attachment) {
    const defaultBsConfig = {
      ...
      onFirstUpdate: data =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (data.originalPlacement !== data.placement) {
...
&nbsp;
  _getOffset() {
    let offset = []
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.config.offset === 'function') {
<span class="cstat-no" title="statement not covered" >      offset = <span class="fstat-no" title="function not covered" >({</span> placement, reference, popper }) =&gt; <span class="cstat-no" title="statement not covered" >this.config.offset(({ placement, reference, popper }))</span></span>
    } else {
...
&nbsp;
    this._hideModalHandler = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      if (this.element) {</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.element.getAttribute('title') || titleType !== 'string') {
...
<span class="cstat-no" title="statement not covered" >      context = new this.constructor(</span>
        event.target,
        this._getDelegateConfig()
      )
<span class="cstat-no" title="statement not covered" >      Data.setData(event.target, dataKey, context)</span>
    }
&nbsp;
    if (event) {
      context._activeTrigger[
        event.type === 'focusin' ? <span class="branch-0 cbranch-no" title="branch not covered" >TRIGGER_FOCUS </span>: TRIGGER_HOVER
      ] = true
    }
&nbsp;
...
&nbsp;
    context._timeout = setTimeout(() =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (context._hoverState === HOVER_STATE_SHOW) {
        context.show()
      }
...
&nbsp;
    if (event) {
      context._activeTrigger[
        event.type === 'focusout' ? <span class="branch-0 cbranch-no" title="branch not covered" >TRIGGER_FOCUS </span>: TRIGGER_HOVER
      ] = false
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (context._isWithActiveTrigger()) {
...
&nbsp;
    context._timeout = setTimeout(() =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (context._hoverState === HOVER_STATE_OUT) {
<span class="cstat-no" title="statement not covered" >        context.hide()</span>
      }
...
&nbsp;
  _getDelegateConfig() {
    const config = {}
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.config) {
...
&nbsp;
  _cleanTipClass() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (tabClass !== null &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >tabClass.length &gt; 0)</span> {
<span class="cstat-no" title="statement not covered" >      tabClass.map(<span class="fstat-no" title="function not covered" >to</span>ken =&gt; <span class="cstat-no" title="statement not covered" >token.trim())</span></span>
        .forEach(<span class="fstat-no" title="function not covered" >tC</span>lass =&gt; <span class="cstat-no" title="statement not covered" >tip.classList.remove(tClass))</span>
    }
  }
&nbsp;
...
&nbsp;
  _fixTransition() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (tip.getAttribute('data-popper-placement') !== null) {
      return
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    tip.classList.remove(CLASS_NAME_FADE)</span>
<span class="cstat-no" title="statement not covered" >    this.config.animation = false</span>
<span class="cstat-no" title="statement not covered" >    this.hide()</span>
<span class="cstat-no" title="statement not covered" >    this.show()</span>
<span class="cstat-no" title="statement not covered" >    this.config.animation = initConfigAnimation</span>
  }
&nbsp;
  // Static
&nbsp;
